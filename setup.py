...
setup(
  name = 'pdfinv-generator',         #* Your package will have this name
  ...
  description = 'This package converts Excel invoices to PDF invoices.',    # Short description of your library
  author = 'Ravi Konjeti',                   # Your name
  author_email = 'ravikonjeti1234@gmail.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['pdfinv', 'invoice', 'excel', 'pdf'],   # Keywords users can search on pypi.org
